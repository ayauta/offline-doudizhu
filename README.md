...
当前版本是 **v0.4.0 公开预览版**，支持 Android 10+ 和现代桌面浏览器。

## 在线试玩与下载

- **GitHub Pages 在线版：** [立即试玩](https://ayauta.github.io/offline-doudizhu/)；安装为 PWA 后可离线启动。
- **Android APK：** 从 [`v0.4.0` Pre-release](https://github.com/ayauta/offline-doudizhu/releases/tag/v0.4.0) 下载 `offline-doudizhu-v0.4.0-android.apk`。
