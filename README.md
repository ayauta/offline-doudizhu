...
当前版本是 **v0.5.0 公开预览版**，支持 Android 10+ 和现代桌面浏览器。

## 在线试玩与下载

- **GitHub Pages 在线版：** [立即试玩](https://ayauta.github.io/offline-doudizhu/)；安装为 PWA 后可离线启动。
- **Android APK：** 从 [`v0.5.0` Pre-release](https://github.com/ayauta/offline-doudizhu/releases/tag/v0.5.0) 下载 `offline-doudizhu-v0.5.0-android.apk`。
...
- 三档纯规则本地 AI：休闲、默认和高手；默认档保持原有策略，增强档只读取脱敏视图；
...
- 退出或重载后不会恢复未完成的牌局；
- 暂无声音；
- 游戏内的文字无法选中（界面里全是按钮与状态文字，没有需要复制的内容）；
