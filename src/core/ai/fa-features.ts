...
import { RANK_ORDER, SEQUENCE_RANKS, type PlayPattern, type ValidatedPlayAction } from "../rules/index.js";
...
/**
 * Maximal runs of the standard ladder in which every rank holds at least
 * `perRank` cards. `runs` counts spans of at least `minimum`; `longest` is the
 * longest span of any length. The two-and-the-jokers tail is excluded by
